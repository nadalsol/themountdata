...
$(document).ready(function() {
  ...
  (function() {
    ...
    modalTriggerVideo.click(function() {
      ...
      modalBodyVideo.append('<video controls autoplay muted preload><source src="/assets/video/the-mount-data.webm" type="video/webm"><source src="/assets/video/the-mount-data.mp4" type="video/mp4">Sorry, your browser does not support embedded videos.</video>'); // 3
    });
